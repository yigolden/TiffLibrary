...
namespace TiffLibrary.PhotometricInterpreters
{
    ...
    /// </summary>
    public sealed class TiffPlanarRgbaAny32323232Interpreter : ITiffImageDecoderMiddleware
    {
        ...
        public TiffPlanarRgbaAny32323232Interpreter(bool isAlphaAssociated, bool undoColorPreMultiplying, TiffValueCollection<ushort> bitsPerSample, TiffFillOrder fillOrder = TiffFillOrder.HigherOrderBitsFirst)
        {
