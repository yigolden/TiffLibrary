...
namespace TiffLibrary.PhotometricInterpreters
{
    ...
    /// </summary>
    public sealed class TiffWhiteIsZeroAny16Interpreter : ITiffImageDecoderMiddleware
    {
        ...
        public TiffWhiteIsZeroAny16Interpreter(int bitCount, TiffFillOrder fillOrder = TiffFillOrder.HigherOrderBitsFirst)
        {
            if ((uint)bitCount > 16)
            {
