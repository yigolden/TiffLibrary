...
namespace TiffLibrary.PhotometricInterpreters
{
    ...
    /// </summary>
    public sealed class TiffWhiteIsZeroAny8Interpreter : ITiffImageDecoderMiddleware
    {
        ...
        public TiffWhiteIsZeroAny8Interpreter(int bitCount, TiffFillOrder fillOrder = TiffFillOrder.HigherOrderBitsFirst)
        {
            if ((uint)bitCount > 8)
            {
