...
{
    internal class TiffPassthroughPixelBufferWriter<TSource, TDestination> : ITiffPixelBufferWriter<TSource> where TSource : unmanaged where TDestination : unmanaged
    {
        ...
        public TiffPassthroughPixelBufferWriter(ITiffPixelBufferWriter<TDestination> writer)
        {
            ...
            _writer = writer ?? TiffEmptyPixelBufferWriter<TDestination>.Default;
        }
